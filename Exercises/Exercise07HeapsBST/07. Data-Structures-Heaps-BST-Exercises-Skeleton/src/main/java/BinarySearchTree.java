...
public class BinarySearchTree<E extends Comparable<E>> {
	...
	public static class Node<E> {
		...
		public Node(Node<E> other) {
			...
			if (other.getLeft() != null) {
				this.leftChild = new Node<E>(other.getLeft());
			}

			if (other.getRight() != null) {
				this.rightChild = new Node<E>(other.getRight());
			}
		}
	...
	public BinarySearchTree(Node<E> otherRoot) {
		this.root = new Node<E>(otherRoot);
	...
	private void nodeInOrder(BinarySearchTree.Node<E> node, Consumer<E> consumer) {
	...
	private void insertInto(BinarySearchTree.Node<E> node, E element) {
...
//		return searchNode(this.root, element) != null;
	...
	private boolean containsNode(BinarySearchTree.Node<E> node, E element) {
	...
	private Node<E> searchNode(BinarySearchTree.Node<E> node, E element) {
	...
	private int nodeRank(BinarySearchTree.Node<E> node, E element) {
	...
	private int getNodeCount(BinarySearchTree.Node<E> node) {
	...
	private boolean isGreater(E element, BinarySearchTree.Node<E> node) {

		return element.compareTo(node.getValue()) > 0;
	}

	private boolean isLess(E element, BinarySearchTree.Node<E> node) {

		return element.compareTo(node.getValue()) < 0;
	}

	private boolean isEqual(E element, BinarySearchTree.Node<E> node) {
